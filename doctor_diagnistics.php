...
if (isset($_POST['submit'])) 
{
    ...
    $_SESSION['diagnose']=$pid;

	

    echo"<ecript>conslode.log($pid,$did)  </script>";
	
		$sql = "SELECT * FROM patient_pre_assessment WHERE pid='$pid' and sid='$did'";
		...
		if ($result->num_rows > 0) {
            header("Location: doctor_diagnistics_help.php");
			
		} else {
			echo "<script>alert('Woops! Nurse has not Done The Initials For This patient Yet!!!!! :)')</script>";
		}
    ...
    <div class="home-content">
      ...
      <div class="sales-boxes">
        ...
        <div class="recent-sales box">
          <div class="title">Diagnose Patient</div>        
		...
		<form action="" method="POST" class="login-email" enctype="multipart/form-data">
			...
			<div class="input-group">
				<button name="submit" class="btn">Diagnose</button>
			</div>
