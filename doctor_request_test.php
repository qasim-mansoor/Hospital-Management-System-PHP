...
if (isset($_POST['submit'])) 
{
    ...
    echo"<ecript>conslode.log($pid,$did)  </script>";
		...
		$sql = "SELECT * FROM diagnostics WHERE pid='$pid' and sid='$did'";
		...
		if ($result->num_rows > 0) {
            header("Location: doctor_request_test_help.php");
			
		} else {
			echo "<script>alert('Woops! Patient has not diagnosed Yet!!!!! :)')</script>";
		}
