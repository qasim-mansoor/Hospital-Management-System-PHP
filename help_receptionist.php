...
if (isset($_POST['submit'])) 
{
    ...
    $_SESSION['appoinment_by_receptionist']=$cnic;

	


	
		$sql = "SELECT * FROM patient_users WHERE pid='$cnic'";
		$result = mysqli_query($db, $sql);

		
		
		if ($result->num_rows > 0) {
            header("Location: receptionist_book_appoinment.php");
    ...
    <div class="home-content">
      ...
      <div class="sales-boxes">
		...
		<form action="" method="POST" class="login-email" enctype="multipart/form-data">
            <p class="login-text" style="font-size: 2rem; font-weight: 800;">Patient ID</p>
