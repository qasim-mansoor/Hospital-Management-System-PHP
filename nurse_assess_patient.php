...
if (isset($_POST['submit'])) 
{
    ...
    $_SESSION['assess_patient']=$pid;

	


	
		$sql = "SELECT * FROM nurse_assignment WHERE pid='$pid' ";
		...
		if ($result->num_rows > 0) {
			...
			echo "<script>alert('Woops! CNIC does'nt exist ... Patient is not assigned to you.!! :)')</script>";
		}
