...
$pid=$_SESSION['pid'];
  ...
  $sqlv = "SELECT distinct(pid),ts_id,pfname,plname,test,result FROM lab_requests natural join test_results where pid='$pid' group by pid  ";
...
<section class="home-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard"> &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Patient Dashboard</span>
      </div>
