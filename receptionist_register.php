...
if (isset($_POST['submit'])) {
	...
	if ($password == $cpassword) {
		...
		if (!$result->num_rows > 0) {
			...
			$profile = "INSERT INTO receptionist_profile (sid,first_name,last_name,gender,city,country,birth_date,age,designation) VALUES('$cnic','$fname_e','$lname_e','$gender_e','$city_e','$country_e','$dob_e','$age_e','$desg')";
